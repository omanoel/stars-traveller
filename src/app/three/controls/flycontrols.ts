...
export class FlyControls {
    ...
    public movementSpeedMultiplier = 1.0;
    public rollSpeed = 0.005;

    public dragToLook = false;
    public autoForward = false;

    public tmpQuaternion = new Quaternion();

    public mouseStatus = 0;
    ...
    public update = (delta: number) => {
        if (this.moveState.forward > 0 || this.moveState.back > 0) {
            ...
            if (this.movementSpeedMultiplier < 1e3) {
                this.movementSpeedMultiplier = this.movementSpeedMultiplier * 1.1;
            }
        } else {
